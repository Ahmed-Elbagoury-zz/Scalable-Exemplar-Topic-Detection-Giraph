...
## log names
logname=Exemplar_Term_Based_${i}_${machines}_${TOPIC_NUM}_${RunNum}_"$(date +%Y%m%d-%H%M%S)"
...
hadoop jar /home/exp/giraph-1.0.0/giraph-examples/target/giraph-examples-1.0.0-for-hadoop-0.20.203.0-jar-with-dependencies.jar  	org.apache.giraph.GiraphRunner \
	...
	org.apache.giraph.examples.TopicVertexVocabBased \
	...
	-ca TopicVertexVocabBased.source=2 -w ${machines} 2>&1 | tee -a ~/logs/giraph/${logfile}
